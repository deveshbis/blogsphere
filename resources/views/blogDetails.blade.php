...
<body>
    <section class="bg-white dark:bg-gray-900 max-w-7xl mx-auto">
        <div class="container px-6 py-10 mx-auto">
            <a href="" class="flex items-center mb-6 text-gray-400 transition-colors duration-300 transform dark:text-gray-600 hover:text-gray-800 dark:hover:text-gray-200">
                <h1 class="text-2xl font-semibold text-gray-800 capitalize lg:text-3xl dark:text-white mb-3">Blog Details</h1>
            </a>
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            <article class="p-6 text-base bg-white rounded-lg dark:bg-gray-900 mb-4">
                                ...
                                <p class="text-gray-500 dark:text-gray-400">${response.body || 'No comment text'}</p>
                            </article>
                        `;
                ...
                success: function(comments) {
                    comments.forEach(function(comment) {
                        ...
                        <article class="p-6 text-base bg-white rounded-lg dark:bg-gray-900 mb-4">
                            ...
                            <p class="text-gray-500 dark:text-gray-400">${comment.body || 'No comment text'}</p>
                        </article>
                    `;
